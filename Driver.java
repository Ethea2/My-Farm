        ...
        do {
            ...
            while (loop) {
                ...
                if (choice == 1) {
                    ...
                    new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
                    System.out.println(String.format("Your farmer registration is: %s", player.getFarmerType().getFarmerType()));
            ...
            if(!farm.getTile().checkPlanted()) {
                System.out.println("You did not plant a crop and had no active crop growing during the night, you lose...");
            }
            else if (player.getObjectcoins() < 5) {
